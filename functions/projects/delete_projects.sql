...
begin
    ...
    -- active'den completed veya archived'e geçiş olabilir
    -- (diğer geçişler zaten serbest)
    ...
    if p_new_status = 'completed' then
        -- Complete et: completed_by ve completed_at doldur
        update projects
        set 
        ...
        -- Reactivate et: completed_by ve completed_at temizle
        update projects
        set 
        ...
        -- Project memberships'leri de soft delete
        ...
        -- Project requirements'leri soft delete
