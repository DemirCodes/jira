...
\restrict 2JrkNSZnXhg4Y29Rwhr3cD7UursFIlME4wy1dE3QIEATzra5sh0UgYc0fn68zBF
...
--
-- Name: public; Type: SCHEMA; Schema: -; Owner: jira
--
...
--
-- Name: SCHEMA public; Type: COMMENT; Schema: -; Owner: jira
--
...
--
-- Name: create_project(uuid, text, text, text, text, boolean); Type: FUNCTION; Schema: public; Owner: jira
--
...
BEGIN
    ...
    IF FOUND THEN
        RAISE EXCEPTION 'Project already exists in this site';
    END IF;
    
    INSERT INTO projects (
        site_id, project_check_id, project_name, project_key,
        board_type, project_description, slug, project_status,
        is_private, created_by, created_at, updated_at
    )
    VALUES (
        p_site_id, encode(gen_random_bytes(6), 'hex'),
        v_project_name, v_project_key, v_board_type,
        p_project_description,
        lower(regexp_replace(v_project_name, '[^a-zA-Z0-9]', '-', 'g')),
        'active', p_is_private, v_user_id, now(), now()
    )
    RETURNING project_id INTO v_project_id;
    
    INSERT INTO project_memberships (
        project_id, user_id, role, invited_by,
        membership_is_active, joined_at, created_at, updated_at
    )
    VALUES (
        v_project_id, v_user_id, 'project_admin', v_user_id,
        true, now(), now(), now()
    );
...
ALTER FUNCTION public.create_project(p_site_id uuid, p_project_name text, p_project_key text, p_board_type text, p_project_description text, p_is_private boolean) OWNER TO jira;
...
--
-- Name: get_next_project_issue_number(uuid); Type: FUNCTION; Schema: public; Owner: jira
--
...
ALTER FUNCTION public.get_next_project_issue_number(p_project_id uuid) OWNER TO jira;
...
ALTER VIEW public.issue_summary OWNER TO jira;
...
--
-- Name: project_issue_counters; Type: TABLE; Schema: public; Owner: jira
--
...
ALTER TABLE public.project_issue_counters OWNER TO jira;
...
--
-- Data for Name: project_issue_counters; Type: TABLE DATA; Schema: public; Owner: jira
--

COPY public.project_issue_counters (project_id, last_value, updated_at) FROM stdin;
\.
...
--
-- Name: project_issue_counters project_issue_counters_pkey; Type: CONSTRAINT; Schema: public; Owner: jira
--
...
--
-- Name: projects_project_key_key; Type: INDEX; Schema: public; Owner: jira
--

CREATE UNIQUE INDEX projects_project_key_key ON public.projects USING btree (project_key);
...
--
-- Name: project_issue_counters project_issue_counters_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: jira
--

ALTER TABLE ONLY public.project_issue_counters
    ADD CONSTRAINT project_issue_counters_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(project_id) ON DELETE CASCADE;
...
\unrestrict 2JrkNSZnXhg4Y29Rwhr3cD7UursFIlME4wy1dE3QIEATzra5sh0UgYc0fn68zBF
