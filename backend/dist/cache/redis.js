...
var getRedisClient = function () {
    if (!redisClient) {
        var redisUrl = process.env.REDIS_URL || 'redis://localhost:6379/0';
        redisClient = new ioredis_1.default(redisUrl, {
            ...
            retryStrategy: function (times) {
                ...
                logger_1.log.warn("Redis reconnecting in ".concat(delay, "ms (attempt ").concat(times, ")"));
                return delay;
            },
...
var closeRedis = function () { return __awaiter(void 0, void 0, void 0, function () {
