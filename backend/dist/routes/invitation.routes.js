...
router.post('/', (0, validate_1.validate)(invitation_schema_1.createInvitationSchema), invitationController.create);
router.post('/accept', (0, validate_1.validate)(invitation_schema_1.acceptInvitationSchema), invitationController.accept);
router.post('/reject', (0, validate_1.validate)(invitation_schema_1.acceptInvitationSchema), invitationController.reject);
